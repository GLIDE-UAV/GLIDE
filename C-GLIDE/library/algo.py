...
from stable_baselines.common import explained_variance, BaseRLModel, ActorCriticRLModel, tf_util, SetVerbosity, TensorboardWriter
...
class PPO2(ActorCriticRLModel):
    ...
    def learn(self, total_timesteps, callback=None, log_interval=1, tb_log_name="PPO2",
        ...
        with SetVerbosity(self.verbose), TensorboardWriter(self.graph, self.tensorboard_log, tb_log_name, new_tb_log) \
            ...
            for update in range(1, n_updates + 1):
                ...
                if writer is not None and self.full_tensorboard_log:
    ...
    def load_parameters(self, load_path_or_dict, explore_again="no", exact_match=True):
        """
        ...
        if explore_again=="yes":
            print("initilizing to explore again!!")
            current_params=self.get_parameters()
            params['model/pi/logstd:0']=current_params['model/pi/logstd:0']
            params['model/pi/w:0']=current_params['model/pi/w:0']
            params['model/pi/b:0']=current_params['model/pi/b:0']
